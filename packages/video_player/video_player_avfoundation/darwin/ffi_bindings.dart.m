...
#import "video_player_avfoundation/Sources/video_player_avfoundation/include/video_player_avfoundation/FVPDefaultDisplayLinkFactory.h"
...
typedef void  (^ListenerBlock5)(struct CGRect , struct CGRect , NSTextContainer* , struct _NSRange , BOOL * );
ListenerBlock5 wrapListenerBlock_ObjCBlock_ffiVoid_CGRect_CGRect_NSTextContainer_NSRange_bool(ListenerBlock5 block) {
  ListenerBlock5 wrapper = [^void(struct CGRect arg0, struct CGRect arg1, NSTextContainer* arg2, struct _NSRange arg3, BOOL * arg4) {
...
ListenerBlock7 wrapListenerBlock_ObjCBlock_ffiVoid_NSTextLayoutManager_NSTextLayoutFragment(ListenerBlock7 block) {
...
ListenerBlock10 wrapListenerBlock_ObjCBlock_ffiVoid_NSInputStream_NSOutputStream_NSError(ListenerBlock10 block) {
...
ListenerBlock16 wrapListenerBlock_ObjCBlock_ffiVoid_NSTextCheckingResult_NSMatchingFlags_bool(ListenerBlock16 block) {
...
ListenerBlock18 wrapListenerBlock_ObjCBlock_ffiVoid_NSURLResponse_NSData_NSError(ListenerBlock18 block) {
...
ListenerBlock25 wrapListenerBlock_ObjCBlock_ffiVoid_NSURLSessionWebSocketMessage_NSError(ListenerBlock25 block) {
...
ListenerBlock26 wrapListenerBlock_ObjCBlock_ffiVoid_NSData_NSURLResponse_NSError(ListenerBlock26 block) {
...
ListenerBlock27 wrapListenerBlock_ObjCBlock_ffiVoid_NSURL_NSURLResponse_NSError(ListenerBlock27 block) {
...
ListenerBlock30 wrapListenerBlock_ObjCBlock_ffiVoid_AVAssetTrackSegment_NSError(ListenerBlock30 block) {
...
ListenerBlock34 wrapListenerBlock_ObjCBlock_ffiVoid_AVMetadataItemValueRequest(ListenerBlock34 block) {
...
ListenerBlock35 wrapListenerBlock_ObjCBlock_ffiVoid_AVMediaSelectionGroup_NSError(ListenerBlock35 block) {
...
ListenerBlock37 wrapListenerBlock_ObjCBlock_ffiVoid_AVFragmentedAssetTrack_NSError(ListenerBlock37 block) {
...
ListenerBlock39 wrapListenerBlock_ObjCBlock_ffiVoid_AVVideoComposition_NSError(ListenerBlock39 block) {
...
ListenerBlock40 wrapListenerBlock_ObjCBlock_ffiVoid_AVAsynchronousCIImageFilteringRequest(ListenerBlock40 block) {
...
ListenerBlock42 wrapListenerBlock_ObjCBlock_ffiVoid_AVMutableVideoComposition_NSError(ListenerBlock42 block) {
...
ListenerBlock45 wrapListenerBlock_ObjCBlock_ffiVoid_Uint8_Uint8_MIDICIProfile_bool(ListenerBlock45 block) {
...
ListenerBlock46 wrapListenerBlock_ObjCBlock_ffiVoid_AVCompositionTrack_NSError(ListenerBlock46 block) {
...
ListenerBlock47 wrapListenerBlock_ObjCBlock_ffiVoid_AVMutableCompositionTrack_NSError(ListenerBlock47 block) {
...
ListenerBlock49 wrapListenerBlock_ObjCBlock_ffiVoid_AVMutableMovieTrack_NSError(ListenerBlock49 block) {
...
ListenerBlock50 wrapListenerBlock_ObjCBlock_ffiVoid_AVFragmentedMovieTrack_NSError(ListenerBlock50 block) {
...
ListenerBlock51 wrapListenerBlock_ObjCBlock_ffiVoid_AVAudioPCMBuffer_AVAudioTime(ListenerBlock51 block) {
...
ListenerBlock53 wrapListenerBlock_ObjCBlock_ffiVoid_AVMusicEvent_ffiDouble_bool(ListenerBlock53 block) {
...
ListenerBlock54 wrapListenerBlock_ObjCBlock_ffiVoid_AVMusicTrack_NSData_ffiDouble(ListenerBlock54 block) {
...
ListenerBlock55 wrapListenerBlock_ObjCBlock_ffiVoid_opaqueCMSampleBuffer_NSError(ListenerBlock55 block) {
...
typedef void  (^ListenerBlock56)(struct opaqueCMSampleBuffer * , AVCaptureBracketedStillImageSettings* , NSError* );
ListenerBlock56 wrapListenerBlock_ObjCBlock_ffiVoid_opaqueCMSampleBuffer_AVCaptureBracketedStillImageSettings_NSError(ListenerBlock56 block) {
  ListenerBlock56 wrapper = [^void(struct opaqueCMSampleBuffer * arg0, AVCaptureBracketedStillImageSettings* arg1, NSError* arg2) {
...
ListenerBlock58 wrapListenerBlock_ObjCBlock_ffiVoid_NSRunningApplication_NSError(ListenerBlock58 block) {
...
ListenerBlock60 wrapListenerBlock_ObjCBlock_ffiVoid_NSWorkspaceAuthorization_NSError(ListenerBlock60 block) {
...
ListenerBlock61 wrapListenerBlock_ObjCBlock_ffiVoid_NSPersistentStoreDescription_NSError(ListenerBlock61 block) {
...
ListenerBlock68 wrapListenerBlock_ObjCBlock_ffiVoid_ffiLong_NSArray_NSOrthography_ffiLong(ListenerBlock68 block) {
